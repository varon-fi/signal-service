-- Tuning Set C candidate for XRP 5m range_mean_reversion
...
--
-- Intent:
-- - entry-timing/price alignment only (no exit-rule changes)
-- - keep RSI/exits pinned from merged Tuning Set B
-- - adjust only vwap_tolerance: 0.0018 -> 0.0015
