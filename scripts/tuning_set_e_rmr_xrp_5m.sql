-- Tuning Set E candidate for XRP 5m range_mean_reversion
...
--
-- Intent:
-- - single-variable entry-timing control delta from authoritative baseline
-- - keep exits unchanged
--
-- Delta from current baseline (comment 3979511679):
