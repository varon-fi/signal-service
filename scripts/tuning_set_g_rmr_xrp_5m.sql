-- Tuning Set G candidate for XRP 5m range_mean_reversion
...
--
-- Intent:
-- - single-variable entry cadence refinement from Set F runtime-aligned baseline
-- - keep exits unchanged
--
-- Delta from Set F baseline:
