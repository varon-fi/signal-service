-- Tuning Set H candidate for XRP 5m range_mean_reversion
...
--
-- Intent:
-- - single-variable entry cadence refinement from Set G runtime-aligned baseline
-- - keep exits unchanged
--
-- Delta from Set G baseline:
