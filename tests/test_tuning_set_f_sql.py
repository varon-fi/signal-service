...
def test_tuning_set_f_sql_targets_expected_strategy_and_params():
    sql_path = Path(__file__).resolve().parents[1] / "scripts" / "tuning_set_f_rmr_xrp_5m.sql"
    ...
    # Single-variable Set F timing delta
    assert "'ema_filter_period', 20" in sql
