...
def test_tuning_set_g_sql_targets_expected_strategy_and_params():
    sql_path = Path(__file__).resolve().parents[1] / "scripts" / "tuning_set_g_rmr_xrp_5m.sql"
    ...
    # Single-variable Set G timing delta
    assert "'ema_filter_period', 15" in sql
