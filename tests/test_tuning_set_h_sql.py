...
def test_tuning_set_h_sql_targets_expected_strategy_and_params():
    sql_path = Path(__file__).resolve().parents[1] / "scripts" / "tuning_set_h_rmr_xrp_5m.sql"
    ...
    # Single-variable Set H timing delta
    assert "'ema_filter_period', 10" in sql
